...
$MONGO["servers"][$i]["control_users"]["admin"] = "7IUzIfupGC";//one of control users ["USERNAME"]=PASSWORD, works only if mongo_auth=false
$MONGO["servers"][$i]["control_users"]["tester"] = "FJtUh99WZrjXeD";//one of control users ["USERNAME"]=PASSWORD, works only if mongo_auth=false
